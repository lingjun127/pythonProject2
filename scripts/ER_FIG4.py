...
print(p_inf)
print(p_inf_layer1 / p)
p_infs.append(1)
p_infs.append(p_inf_layer1 / p)
print("----------")
n = 2
...
while n < 80:
    ...
    n = n + 1
ERn1000k8_1 = np.array(p_infs)
print(ERn1000k8_1)
np.savetxt('../notebooks/results/ER/FIG4/ERn1000k8_1.csv', ERn1000k8_1, delimiter=',')
